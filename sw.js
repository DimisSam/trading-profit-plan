...
function loadSavedValues() {
    const fields = ["profitRate", "startDate", "inDeposit", "exDeposit", "bonus", "rateUSDC", "wAmount"];
    fields.forEach(id => {
...
function updateWithdrawal() {
    ...
    const kratiseis = wAmount * 0.05;
    document.getElementById("kratiseis").value = kratiseis.toFixed(2);

    const metaKratiseis = wAmount - kratiseis;
    document.getElementById("wAmountEUR").value = (metaKratiseis * rate).toFixed(2);
